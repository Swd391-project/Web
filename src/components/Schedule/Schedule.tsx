...
//     dataBooking: BookingListColumns;
// }

// export const Schedule: React.FC<CellActionProps> = ({ dataBooking }) => {
...
//     const openDialog = (booking: BookingListColumns) => {
//         onOpen("CheckInCheckOutForm", { booking: dataBooking });
//     };
...
//                                     <td key={index} className={booking ? "highlight" : ""}>
//                                         {booking ? (
//                                             <>
//                                                 {`Mã đặt sân: ${booking.id}\nTên khách hàng: ${booking.customer.name}\nTrạng thái: ${booking.status}\n`}
//                                                 <Button
//                                                     onClick={() => onOpen("CheckInCheckOutForm", { booking: dataBooking })}
//                                                     className="ml-2"
//                                                 >
//                                                     Check in/Check out
//                                                 </Button>
