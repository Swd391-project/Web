...
// interface EditCICOFormProps {
//     onUpdate: () => any; // Define the type of onUpdate prop
// }

// const CheckInCheckOutForm: React.FC<EditCICOFormProps> = ({ onUpdate }) => {
...
//                 <Button variant="outline">Check in/Check out</Button>
//             </DialogTrigger>
...
interface EditCICOFormProps {
    onUpdate: (date?: string) => any; // Define the type of onUpdate prop
}
const CheckInCheckOutForm: React.FC<EditCICOFormProps> = ({ onUpdate }) => {
    const { isOpen, type, onClose, data } = useModal();
    const isModalOpen = isOpen && type === "CheckInCheckOutForm";
    ...
    const isCheckInDisabled = data?.booking?.status === 'InProgress';
                ...
                <Tabs defaultValue="checkIn" className="w-[400px]">
                    ...
                    <TabsContent value="checkIn">
                        <form onSubmit={form.handleSubmit(onCheckInSubmit)}>
                            {/* Add any necessary form fields here */}
                            <DialogFooter>
                                <Button type="submit" disabled={isLoading || isCheckInDisabled}>
                                    Check In
                                </Button>
                            </DialogFooter>
                        </form>
